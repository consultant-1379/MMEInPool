 ...
 *******************************************************************************
 *----------------------------------------------------------------------------*/
package com.ericsson.mmepool.handler.control;
...
public class ControlEventSenderComponent extends AbstractEventHandler implements EventInputHandler {
    ...
    public void onEvent(final Object inputEvent) {
        ...
        if (SEND_CONTROL_EVENT_TRIGGER.equals(inputEvent)) {
            final ControlEvent ce = new ControlEvent(CONTROL_EVENT_PAUSE_TYPE);
            getEventHandlerContext().sendControlEvent(ce);
